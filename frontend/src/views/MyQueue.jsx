...
const MyQueue = (props) => {
    ...
    const myCards = queueData.find((entry) => entry["user_profiles"]["name"] === MY_NAME);
    return (

        <div style={{ maxHeight: "70vh", overflowY: "auto" }}>
            <Space direction="vertical" size={16}>
                {myCards ? (
                    <Card size="small" title={`(${myCards["user_profiles"]?.["gender"]}) ${myCards["user_profiles"]?.["name"]}`} style={{ width: 300 }}>
